                            ...
                            <form method="post" action="{{ route('subjects.store') }}">
                                ...
                                <div class="pl-lg-4">
                                    ...
                                    <div class="form-group{{ $errors->has('nr_of_points') ? ' has-danger' : '' }}">
                                        ...
                                        <input type="text" name="nr_of_points" id="input-name" class="form-control form-control-alternative{{ $errors->has('nr_of_points') ? ' is-invalid' : '' }}" placeholder="{{ __('Number of Points')}}">
                                    ...
                                    <div class="form-group{{ $errors->has('nr_of_points') ? ' has-danger' : '' }}">
                                        ...
                                        <input type="text" name="nr_of_pds" id="input-name" class="form-control form-control-alternative{{ $errors->has('nr_of_points') ? ' is-invalid' : '' }}" placeholder="{{ __('Number of PDS')}}">
                                    ...
                                    <div class="form-group{{ $errors->has('module_id') ? ' has-danger' : '' }}">
                                        ...
                                        <select name="sub_module_id" class="form-control form-control-alternative{{ $errors->has('sub_module_id') ? ' is-invalid' : '' }}">
                                            <option value="">Choose Sub Module</option>
                                            @foreach($subModules as $subModule)
                                                <option value="{{ $subModule->id }}">{{ $subModule->description }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <a type="button" href="{{ route('subject.subIndex', $subModuleId->id) }}" class="btn btn-danger mt-4">{{ __('Back') }}</a>
                                </div>
                            </form>
                        </div>
                    </div>
