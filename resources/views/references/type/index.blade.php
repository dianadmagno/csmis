                    ...
                    <div class="card">
                        ...
                        <div class="card-header border-0">
                            <div class="row align-items-center">
                                <div class="col-8">
                                    <h3 class="mb-0">List of Student Type</h3>
                                </div>
                                <div class="col-4 text-right">
                                    <a href="{{ route('type.create') }}" class="btn btn-sm btn-primary">Add Student Type</a>
                                </div>
                            </div>
                            @if (session('status'))
                                <br>
                                ...
                                <tbody class="list">
                                    @foreach($student_types as $type)
                                        <tr>
                                            ...
                                            <td>
                                                <div class="row">
                                                    <a href="{{ route('type.edit', $type->id) }}" class="btn btn-primary" type="button">
                                                        Edit
                                                      </a>
