            ...
            <div class="row">
                <div class="col">
                    <div class="card">
                        <!-- Card header -->
                        <div class="card-body">
                            <form method="post" action="{{ route('islandGroup.store') }}">
                                @csrf
                                ...
                                <div class="pl-lg-4">
                                    ...
                                    <a type="button" href="{{ route('islandGroup.index') }}" class="btn btn-danger mt-4">{{ __('Back') }}</a>
                                </div>
                            </form>
                        </div>
                    </div>
