                              ...
                              <th scope="row">
                                <div class="media align-items-center">
                                  <div class="media-body">
                                    <span class="name mb-0 text-sm">{{ $rank->name }}</span>
                                  </div>
                                </div>
                              </th>
                              <td class="budget">
                              ...
                              <td>
                                <div class="row">
                                  <form action="{{ route('ranks.destroy', $rank->id) }}" method="post">
                                    ...
                                    <button type="submit" onclick="return alert('Do you really want to delete this rank?')" class="btn btn-danger">Delete</button>
                                </form>
                                </div>
                              </td>
                            </tr>
